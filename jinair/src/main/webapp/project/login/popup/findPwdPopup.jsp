	...
	<div id="popCont">
		<form name="form" id="form">
			...
			<input type="hidden" name="from" value="FIND_PW">
				...
				<ul class="caution">
				   	<li>회원가입 시 기재한 이름/생년월일/이메일 및 아이디 정보를 입력해 주세요.</li>
					<li>등록된 이메일로 임시 비밀번호를 발송해 드립니다.</li>
				</ul>
				...
				<table class="fieldForm">
					...
					<tr>
						<th scope="row">아이디</th>
						<td><input type="text" name="id" id="id" title="아이디" maxlength="20" style="text-transform:uppercase;"></td>
					</tr>
					<tr>
						<th scope="row">이름</th>
						<td>
				...
				<div class="btnArea">
					<span><a href="javascript://" role="btn-member-find-pw" class="btnTypeA">확인</a></span>
