...
function showLoading(target){
	if(target){
		...
		$(""+target+"").prepend("<div class='loadingArea'><img src='/images/common/loading.gif' alt='loading'></div>");
	} else {
		if(!!$('body').find('.loadingArea').length) {
			return;
		}

		$("body").prepend("<div class='loadingArea full'><img src='/images/common/loading.gif' alt='loading'></div>");
	}
}
