...
<div class="step">
	...
	<ol>
		...
		<form id="registerform2"> <!-- ******************************** -->
			<c:set var="i" value="1"/>
			<c:forEach var="num" begin="1" end="${ param.adultPaxCount}" step="1">
				<br>
				<h3 style="font-size: 25px; font-weight: 25px;">성인 - ${ num }</h3>
				<table>
					<tr>
						<td height="50px" width="100px">이름 </td>
						<td><input id="name${ i }" type="text" name="name${ i }"/></td>
						<td height="50px" width="100px">성별 </td>
						<td><input id="sex${ i }" type="text" name="sex${ i }"/></td>
					</tr>
					<tr>
						<td height="50px" width="100px">생년월일</td>
						<td><input id="birth${ i }" type="text" name="birth${ i }"/></td>
						<td height="50px" width="100px">국적</td>
						<td><input id="nationality${ i }" type="text" name="nationality${ i }"/></td>
					</tr>
					<tr>
						<td height="50px" width="100px">회원아이디</td>
						<td width="45%"><input id="mId${ i }" type="text" name="mId${ i }"/><button  type="button" id="checkmId${ i }" style="background-color: #BDD600; width: 20%;height: 30px;">ID Check</button></td>
						<td height="50px" width="100px">추가할인</td>
						<td><input id="discount${ i }" type="text" name="discount${ i }"/></td>
					</tr>
				</table>
				<hr />
				<c:set var="i" value="${ i +1 }"/>
			</c:forEach>
			<c:forEach var="num" begin="1" end="${ param.childPaxCount}" step="1">
				<br>
				<h3 style="font-size: 25px; font-weight: 25px;">소아 - ${ num }</h3>
				<table>
					<tr>
						<td height="50px" width="100px">이름 </td>
						<td><input id="name${ i }" type="text" name="name${ i }"/></td>
			...
			<c:forEach var="num" begin="1" end="${ param.infantPaxCount}" step="1">
				<br>
				<h3 style="font-size: 25px; font-weight: 25px;">유아 - ${ num }</h3>
				<table>
					<tr>
						<td height="50px" width="100px">이름 </td>
						<td><input id="name${ i }" type="text" name="name${ i }"/></td>
					...
					<tr>
						<td height="50px" width="100px">보호자</td>
						<td  width="45%"><input id="parent${ i }" type="text" name="parent${ i }"/></td>
					</tr>
				</table>
				<hr />
				<c:set var="i" value="${ i +1 }"/>
			...
			<h3 style="font-size: 25px; font-weight: 25px;">예매자 정보</h3>
			<hr />
			<table>
				<tr>
					<td height="50px" width="130px">이메일 </td>
					<td><input type="text" id ="email" name="email"/></td>
				</tr>
				<tr>
					<td height="50px" width="130px">예매자 휴대폰번호</td>
		...
		<script>
			...
			$("#registerform2 button").on("click", function() {
				var mid = $(this).attr("id").substr(-4);
				var param = "mid="+$('#'+mid).val();
				//alert(param);
				
				$.ajax({
					url:"checkid.do", // 프로젝트 	MVC idcheck.do->  컨트롤러 -> 모델
			...
			function next() {
				for(var i = 1; i < ${i}; i++){
					...
					$("#registerform").append("<input type='hidden' id='name"+i+"' name='name"+i+"' value='"+$("#registerform2 #name"+i).val()+"'/>");
					$("#registerform").append("<input type='hidden' id='sex"+i+"' name='sex"+i+"' value='"+$("#registerform2 #sex"+i).val()+"'/>");
					$("#registerform").append("<input type='hidden' id='birth"+i+"' name='birth"+i+"' value='"+$("#registerform2 #birth"+i).val()+"'/>");
					$("#registerform").append("<input type='hidden' id='nationality"+i+"' name='nationality"+i+"' value='"+$("#registerform2 #nationality"+i).val()+"'/>");
					
					
					if($("#registerform2 #parent"+i).val() != "")
						$("#registerform").append("<input type='hidden' id='parent"+i+"' name='parent"+i+"' value='"+$("#registerform2 #parent"+i).val()+"'/>");
					else{			
						$("#registerform").append("<input type='hidden' id='mId"+i+"' name='mId"+i+"' value='"+$("#registerform2 #mId"+i).val()+"'/>");
						$("#registerform").append("<input type='hidden' id='discount"+i+"' name='discount"+i+"' value='"+$("#registerform2 #discount"+i).val()+"'/>");
					}
				}
				$("#registerform").append("<input type='hidden' id='email' name='email' value='"+$("#registerform2 #email").val()+"'/>asdf");
				$("#registerform").append("<input type='hidden' id='tel' name='tel' value='"+$("#registerform2 #tel").val()+"'/>");
				//alert($("#registerform #email").val());
				//alert($("#registerform #tel").val());
