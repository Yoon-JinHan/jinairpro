...
$(document).ready(function() {
	...
	$('.cal a').on('click', function() {
		var url = '/jinair/jinairfront/www.jinair.com/popup/ageCalculator';
...
//	var multiCheck = $('input[name=tripType]:checked').val() == "MC" || $("#registerform #pnrNumber").val() != "";
	...
	if(!!route) {
		showPopupLayer("/jinair/jinairfront/www.jinair.com/popup/noteDestination?destination=" + route);
		return false;
	}
	...
	if(!!country) {
		showPopupLayer("/jinair/jinairfront/www.jinair.com/popup/noteDestination?destination=" + country);
		return false;
	}
...
function jsClickBonusCouponBtn(isLogin){
	if ( isLogin ){
		showPopupLayer('/jinair/jinairfront/www.jinair.com/popup/bonus');
	} else {
